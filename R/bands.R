...
#' In this case, [bands()] will query [tabulate()] multiple times, using the [get_quantiles()] function with the following additional parameters.
...
bands = function(data, qi, ci = c(0.90, 0.95, 0.99, 0.999)){
